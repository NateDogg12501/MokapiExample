...
if (offset > 0) {
    console.log(
        ...
        `mock=${ports.MOKAPI_API_PORT} in .env`
    )
} else {
    console.log(`Primary checkout — using default ports backend=${ports.BACKEND_PORT}, dashboard=${ports.MOKAPI_DASHBOARD_PORT}, mock=${ports.MOKAPI_API_PORT} in .env`)
}
